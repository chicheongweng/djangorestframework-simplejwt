...
class TestTokenBackend(TestCase):
    ...
    def test_jwks(self):
        AUDIENCE = "api://a1709a6a-1ee4-4cc5-89b8-5bce19228ef4"
        ISSUER = "https://sts.windows.net/0d20beb9-3e92-487c-8b46-08f3ed22b3ea/"
        JWK_URL = ISSUER + "discovery/v2.0/keys"
        self.jwks_url_backend = TokenBackend(algorithm="RS256",audience=AUDIENCE,issuer=ISSUER,jwk_url=JWK_URL)
        azure_raw_token = "eyJ0eXAiOiJKV1QiLCJhbGciOiJSUzI1NiIsIng1dCI6IjlHbW55RlBraGMzaE91UjIybXZTdmduTG83WSIsImtpZCI6IjlHbW55RlBraGMzaE91UjIybXZTdmduTG83WSJ9..ncrnvdMKcsJEEq3_kSXAYKVP-5MAi57YkDNWvRGEHX7L38w9mdbz8aX_zgOncMLJf4o3WSWqqs7qrsxy_ruXcqh_o4GHuw7jpBKFcc5yIPI-GqoG8diyWCjaWLamXt7r3370yV3hwpdTcVB3M-CwLcgsOfoxzvC1V8FQ_cWhnHNEGl69ObEEdP0zaszQfjdcuJBKIc6E3Z0rEj0r80VegwFuOjSZCB5N9O4NKFM3iLN-fM4_5tXjzcHlSs2e04ycupG-2L0EaadkJMJ-wtf9VgSDBQ68541Ny5RY_wBOzrgZSKQs5SIsluXrid57GE54wZ3ZyReWoxxchKQJjf6BhA"
        self.jwks_url_backend.get_verifying_key(azure_raw_token)
        decoded = self.jwks_url_backend.decode(azure_raw_token)
        #print("key = %s" % key)
