...
AUDIENCE = "api://7c5e4973-7cab-44cc-bf1b-e38a1dadea6d"

ISSUER = "https://sts.windows.net/90d61637-9965-47b8-8e67-e970de8861d6/"

JWK_URL = "https://sts.windows.net/90d61637-9965-47b8-8e67-e970de8861d6/discovery/v2.0/keys"
...
class TestTokenBackend(TestCase):
    ...
    def test_encode_aud_iss(self):
        ...
        self.assertIn(
            ...
            (
                ...
                "eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjk0NjY4NDgwMCwiYXVkIjoiYXBpOi8vN2M1ZTQ5NzMtN2NhYi00NGNjLWJmMWItZTM4YTFkYWRlYTZkIiwiaXNzIjoiaHR0cHM6Ly9zdHMud2luZG93cy5uZXQvOTBkNjE2MzctOTk2NS00N2I4LThlNjctZTk3MGRlODg2MWQ2LyJ9.k-8sPpozPZpqgAGwzbLa5Ro_Us5hwnIkrpYjRA8fTA-3u45Ipac4DPloSGcqiYh3qsnxT6JQNOmMMZ12B7JmkyjPRhWI9yGz7-hj7dHhY8VnkDYu6rQecj8sYyyESfsWmCoKVnBGhCYEMacVPqG0SZg97Qy-cJromM03Ks2yHcDkqGPhx94dUyhGB9ZeeSXHb4y2oAXe1YTAaOhTesAqgr3E9nAsMuLW8HSYnqbH4WGXvChxl4QPpE49Tb7pGKlql-ZMHYvnhgS2ZFBcXWLATda4xf1ZpIaSrDW8GzSQ_Q7YNanNWzLAcfZOBU_PYdqXcPOLXsrI9d7THmNAhVR6iQ",
            ),
        )
    ...
    def test_jwks(self):
        self.jwks_url_backend = TokenBackend(algorithm="RS256",audience=AUDIENCE,issuer=ISSUER,jwk_url=JWK_URL)
        azure_raw_token = "eyJ0eXAiOiJKV1QiLCJhbGciOiJSUzI1NiIsIng1dCI6IjlHbW55RlBraGMzaE91UjIybXZTdmduTG83WSIsImtpZCI6IjlHbW55RlBraGMzaE91UjIybXZTdmduTG83WSJ9..QIy0nUosOvoUDLf9FM4d3jaB3oWstzmbn9GDi1_nAPVXgZ3xmMRmJRQ3pds_sI2x30_zo-7-VoSsYc--s2yCrpxZ9IbdDjlWSO6RskSM3HS19ovfsLiffSfcvZYkIm_wRYwSUKuQ_3Rp7n6-JVupHal0lAK0cTio_SCVfXfJRIHJFvHNqdz3hmVVhV9BxCpTPBQ85jinnHV4jrRrt8iAlRwU0514kic8wgtblQRKmyJ539Vd6k-ceIhqRL6ZTTAlQVXksfpRsdn4PgPgdm07TxiW1_RneayWJwXrJuBoNRwPnGkxfhxeKjKhgLQ3E-VRt0805rA7E6QwxVs2s1FDpg"
        self.jwks_url_backend.get_verifying_key(azure_raw_token)
        self.jwks_url_backend.decode(azure_raw_token)
        #print("key = %s" % key)
